...
(function() {
  ...
  MonoistEnvModWide = (function() {

    function MonoistEnvModWide() {
      ...
      this.osc2.type = 'sine';
      this.osc2.frequency.value = Audanism.Audio.Harmonizer.getFreqFromNote(this.note);
    ...
    MonoistEnvModWide.prototype.noteOn = function(note) {
    ...
    MonoistEnvModWide.prototype.noteOff = function() {
      var now, releaseTime;
      now = Audanism.Audio.audioContext.currentTime;
